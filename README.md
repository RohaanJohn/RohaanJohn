...
Hi! I am a second year computer science student at Mar Baselios College of Engineering and Technology, Trivandrum. I am a Django developer. I know how to make REST APIs using Django REST Framework and make dynamic websites using Django Web Framework. 

I have also created sequential models and further trained them using Tensorflow to make accurate predictions for different instances. I am familiar with Python, Java and C as well. My aim is to create applications that are unique and beneficial for others.
